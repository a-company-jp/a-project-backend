...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.tagDo.UseModel(&gModel.Tag{})
...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*gModel.Tag) error
	CreateInBatches(values []*gModel.Tag, batchSize int) error
	Save(values ...*gModel.Tag) error
	First() (*gModel.Tag, error)
	Take() (*gModel.Tag, error)
	Last() (*gModel.Tag, error)
	Find() ([]*gModel.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gModel.Tag, err error)
	FindInBatches(result *[]*gModel.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gModel.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gModel.Tag, error)
	FirstOrCreate() (*gModel.Tag, error)
	FindByPage(offset int, limit int) (result []*gModel.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*gModel.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*gModel.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*gModel.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*gModel.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gModel.Tag), nil
	}
}

func (t tagDo) Take() (*gModel.Tag, error) {
...
func (t tagDo) Last() (*gModel.Tag, error) {
...
func (t tagDo) Find() ([]*gModel.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*gModel.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gModel.Tag, err error) {
	buf := make([]*gModel.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*gModel.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*gModel.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*gModel.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*gModel.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*gModel.Tag) (result gen.ResultInfo, err error) {
