...
func newSchemaMigration(db *gorm.DB, opts ...gen.DOOption) schemaMigration {
	...
	_schemaMigration.schemaMigrationDo.UseModel(&gModel.SchemaMigration{})
...
type ISchemaMigrationDo interface {
	...
	Create(values ...*gModel.SchemaMigration) error
	CreateInBatches(values []*gModel.SchemaMigration, batchSize int) error
	Save(values ...*gModel.SchemaMigration) error
	First() (*gModel.SchemaMigration, error)
	Take() (*gModel.SchemaMigration, error)
	Last() (*gModel.SchemaMigration, error)
	Find() ([]*gModel.SchemaMigration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gModel.SchemaMigration, err error)
	FindInBatches(result *[]*gModel.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gModel.SchemaMigration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gModel.SchemaMigration, error)
	FirstOrCreate() (*gModel.SchemaMigration, error)
	FindByPage(offset int, limit int) (result []*gModel.SchemaMigration, count int64, err error)
...
func (s schemaMigrationDo) Create(values ...*gModel.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) CreateInBatches(values []*gModel.SchemaMigration, batchSize int) error {
	return s.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (s schemaMigrationDo) Save(values ...*gModel.SchemaMigration) error {
	if len(values) == 0 {
		return nil
	}
...
func (s schemaMigrationDo) First() (*gModel.SchemaMigration, error) {
	if result, err := s.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gModel.SchemaMigration), nil
	}
}

func (s schemaMigrationDo) Take() (*gModel.SchemaMigration, error) {
...
func (s schemaMigrationDo) Last() (*gModel.SchemaMigration, error) {
...
func (s schemaMigrationDo) Find() ([]*gModel.SchemaMigration, error) {
	result, err := s.DO.Find()
	return result.([]*gModel.SchemaMigration), err
}

func (s schemaMigrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gModel.SchemaMigration, err error) {
	buf := make([]*gModel.SchemaMigration, 0, batchSize)
...
func (s schemaMigrationDo) FindInBatches(result *[]*gModel.SchemaMigration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (s schemaMigrationDo) FirstOrInit() (*gModel.SchemaMigration, error) {
...
func (s schemaMigrationDo) FirstOrCreate() (*gModel.SchemaMigration, error) {
...
func (s schemaMigrationDo) FindByPage(offset int, limit int) (result []*gModel.SchemaMigration, count int64, err error) {
...
func (s schemaMigrationDo) Delete(models ...*gModel.SchemaMigration) (result gen.ResultInfo, err error) {
