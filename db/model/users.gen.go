...
type User struct {
	...
	FirstnameKana *string   `gorm:"column:firstname_kana;type:varchar(255)" json:"firstname_kana"`
	LastnameKana  *string   `gorm:"column:lastname_kana;type:varchar(255)" json:"lastname_kana"`
	...
	Tags          []UserTag `gorm:"many2many:user_tags" json:"tags"`
}
